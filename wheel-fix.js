...
function init(){
  ...
  var timer=setInterval(function(){
    ...
    function draw(){
      ...
      var cx=w/2,cy=w/2,r=w/2-12,s=2*Math.PI/a.length;ctx.save();ctx.translate(cx,cy);
